...
export const QUIZZES = {
  family: [
    ...
    { q: "如果你一週完全不管家裡的事，會怎樣？", icon: "🏝️", opts: ["家裡大概會停擺", "會亂一陣子才有人接手", "有點不方便但還能運作", "其他人完全能應對"] },
  ],
  couple: [
    { q: "你們的日常用品（衛生紙、洗衣精、牙膏）快沒了，誰先注意到？", icon: "🧴", opts: ["永遠是我", "大多是我", "差不多各半", "另一半比較細心"] },
    { q: "情人節、紀念日、對方生日，誰在規劃慶祝？", icon: "🎂", opts: ["都是我在張羅", "我會規劃大方向", "會一起討論", "另一半比較浪漫"] },
    { q: "家裡要修東西、叫瓦斯、處理帳單，誰在追蹤？", icon: "🔧", opts: ["全部是我的事", "大部分我處理", "有明確分工", "另一半比較擅長"] },
    { q: "吵架之後，通常誰先開口修復關係？", icon: "💬", opts: ["永遠是我", "大多是我", "看情況", "另一半會先示好"] },
    { q: "煮飯／點外賣／決定吃什麼，這件事有多累？", icon: "🍽️", opts: ["幾乎都是我煩惱", "大多是我決定", "一起討論", "另一半會安排"] },
    { q: "要去哪裡玩、假日做什麼，誰在規劃行程？", icon: "🗓️", opts: ["都是我在查", "我提案居多", "一起規劃", "另一半比較積極"] },
    { q: "你多常覺得「我不提，對方就不會想到」？", icon: "🫠", opts: ["幾乎每天", "一週好幾次", "偶爾", "很少"] },
    { q: "家事分配上，你覺得另一半了解你做了多少嗎？", icon: "🤔", opts: ["完全不了解", "只知道一部分", "大致了解", "很清楚並且感謝"] },
    { q: "你有因為「對方好像什麼都不在意」而感到孤單嗎？", icon: "🥲", opts: ["經常", "忙的時候會", "偶爾", "很少"] },
    { q: "如果你一週完全不管家事和規劃，會怎樣？", icon: "🏝️", opts: ["另一半可能不會注意到少了什麼", "會亂一陣子", "有點不方便但還行", "另一半完全能接手"] },
  ],
  roommate: [
    { q: "公用的垃圾袋、洗碗精、衛生紙，誰在補貨？", icon: "🧻", opts: ["永遠是我", "大多是我", "差不多各半", "室友比較常買"] },
    ...
    { q: "帳單分攤、網路費、水電費，誰在追蹤和催繳？", icon: "📋", opts: ["全部是我在記", "大部分我處理", "有明確分工", "室友比較擅長這些"] },
...
// MBTI-style personality type mapping for viral sharing
export const PERSONALITY_TYPES = {
  family: {
    high:     { type: "家庭隱形 CEO", tag: "#全能管家型", emoji: "👑", desc: "你是家裡的靈魂人物，沒有你一切都會停擺" },
    mid:      { type: "默默付出者", tag: "#溫柔守護型", emoji: "🌙", desc: "你總是默默扛起那些「沒人注意到」的事" },
    low:      { type: "協作夥伴", tag: "#平衡分工型", emoji: "⚖️", desc: "你們已經建立了不錯的分工基礎" },
    good:     { type: "家庭模範生", tag: "#理想分工型", emoji: "🌟", desc: "你們是少數真正做到均衡分工的家庭" },
  },
  couple: {
    high:     { type: "感情裡的隱形 CEO", tag: "#全能操心型", emoji: "👑", desc: "你在這段關係中承擔了絕大部分的心理負擔" },
    mid:      { type: "關係守護者", tag: "#細膩付出型", emoji: "🌙", desc: "你是維繫關係的那個人，但對方未必看見" },
    low:      { type: "磨合中的伴侶", tag: "#成長進行型", emoji: "⚖️", desc: "你們正在找到屬於自己的分工節奏" },
    good:     { type: "神仙眷侶", tag: "#默契滿分型", emoji: "🌟", desc: "你們的分工讓人羨慕" },
  },
  roommate: {
    high:     { type: "合租界的隱形 CEO", tag: "#全能室友型", emoji: "👑", desc: "這個家沒有你大概會崩潰" },
    mid:      { type: "宿舍管理員", tag: "#默默維護型", emoji: "🌙", desc: "你在背後維持著這個空間的運轉" },
    low:      { type: "和平共處者", tag: "#各自安好型", emoji: "⚖️", desc: "分工還算可以，偶爾有小摩擦" },
    good:     { type: "夢幻室友", tag: "#完美默契型", emoji: "🌟", desc: "這種室友關係可遇不可求" },
  },
};
